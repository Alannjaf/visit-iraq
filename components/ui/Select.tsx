  ...
  ({ className, label, error, options, placeholder, id, ...props }, ref) => {
    ...
    return (
      <div className="w-full">
        {label && (
          <label htmlFor={selectId} className="block font-semibold mb-2 text-[var(--foreground)]">
            {label}
          </label>
        )}
        <select
          ...
          id={selectId}
          className={cn(
            "w-full px-4 py-3 border-2 rounded-lg bg-white text-[var(--foreground)] transition-all duration-300 appearance-none cursor-pointer",
